  ...
  //function used only to check if all the pages do their job
    ...
    */
    ...
    if(currentPage === 'quiz6') {
        ...
        return inizioQuiz6(/*goBackToQuiz6,*/link,ctx,id,setNextQuizType,nextQuizType,platform,handleNextClick);
      }else if (currentPage === 'NextVs'){
...
//second page
function inizioQuiz6(/*goBackToQuiz6,*/link,ctx,id,setNextQuizType,nextQuizType,platform,handleNextClick){
    ...
    return(
        <div className = 'start' id='start'>
            ...
            <div className= "second_line2">
                ...
                <div className='q'>
                    <a href={link} target=':blank'>Click here and open YouTube to see the Machine Learning Video</a>
                </div>
            </div>
