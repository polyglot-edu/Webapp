  ...
  */
  ...
  if (currentPage === "quiz3") {
    ...
    return inizioQuiz3(
      ...
      setCurrentPage,
      question,
      setIsButtonCheckDisabled,
      isButtonCheckDisabled,
    );
  } else if (currentPage === "NextVs") {
    ...
    <div className="start" id="start">
      ...
      <div className="second_line2">
        ...
        <div className="starttext">
          <label className="Text" htmlFor="areaOfText">
            Use exactly {numberOfWords} word/s and write the first letter in
            capital letters:
          </label>
          ...
          <h1 id="resp" className="resp">
            {isCorrect1}
          </h1>
          <button
            id="ButtonCheck"
            className="ButtonCheck"
            onClick={() => saveText(setIsButtonCheckDisabled)}
