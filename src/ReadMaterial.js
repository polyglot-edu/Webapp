...
function ReadMaterial(){
    ...
    if(currentPage === 'quiz7') {
        ...
        return inizioQuiz7(/*goBackToQuiz7,*/setCurrentPage,text,link,ctx,id,textlink);
      }else if (currentPage === 'NextVs'){
...
//second page
function inizioQuiz7(/*goBackToQuiz7,*/setCurrentPage,text,link,ctx,id,textlink){
    ...
    return(
        <div className = 'start' id='start'>
            ...
            <div className='third_line2'>
              ...
              <button id='Next2' className='Next2' onClick={() => nextQuiz(setCurrentPage,ctx,id)}>Next Activity</button>
            </div>
        </div>
    );
}
...
function NextVs(/*goBackToQuiz7*/){
  ...
  return(
    <div className='Vscode'>
      ...
      <div className='second_line'>
        <h1 className='h1vs'>The next exercise is in VSCode, please open your notebook and run again the scripts</h1>
      </div>
    </div> 
  )
